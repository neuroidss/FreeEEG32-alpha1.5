...
boolean CConfigurationFreeEEG32a1_5::setComInit(const CString& sComInit)
{
        m_sComInit=sComInit;
        return true;
}
...
CString CConfigurationFreeEEG32a1_5::getComInit(void) const
{
        return m_sComInit;
}

boolean CConfigurationFreeEEG32a1_5::setComDelay(uint32 iComDelay)
{
...
uint32 CConfigurationFreeEEG32a1_5::getComDelay(void) const
{
        return m_iComDelay;
}
