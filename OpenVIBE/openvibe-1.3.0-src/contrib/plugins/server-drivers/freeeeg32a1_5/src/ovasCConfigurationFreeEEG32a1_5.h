 ...
 *
 */
#ifndef __OpenViBE_AcquisitionServer_CConfigurationFreeEEG32a1_5_H__
#define __OpenViBE_AcquisitionServer_CConfigurationFreeEEG32a1_5_H__
...
{
	class CConfigurationFreeEEG32a1_5 : public OpenViBEAcquisitionServer::CConfigurationBuilder
	{
	public:
		CConfigurationFreeEEG32a1_5(const char* sGtkBuilderFileName, OpenViBE::uint32& rUSBIndex);
		virtual ~CConfigurationFreeEEG32a1_5(void);
...
#endif // __OpenViBE_AcquisitionServer_CConfigurationFreeEEG32a1_5_H__
